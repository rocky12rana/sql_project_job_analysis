...
/*
SQL is the #1 core skill → almost every role needs it
Python is nearly as important → especially for advanced analytics
Tableau dominates visualization tools
*/
